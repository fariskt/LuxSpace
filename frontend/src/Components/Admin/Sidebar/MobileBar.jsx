...
const MobileBar = ({ setActivePage, activePage,setIsMobile }) => {
  ...
  return (
    <div className="fixed top-0 h-full left-0 md:w-[90%] w-[90%] z-10 bg-gray-800 text-white flex flex-col justify-between pt-8">
      <div>
      <button className="md:hidden block absolute right-4 -mt-5 text-4xl" onClick={()=> setIsMobile(false)}><IoClose/></button>
